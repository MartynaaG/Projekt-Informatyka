...
def trial(win, stim, conf):   
    """probowalismy wrzucic fix_cross jako czwarty parametr, ale 
        nie czytalo go trial() missing 1 required positional 
        argument: 'fix_cross'"""
...
def part_of_experiment(win, conf, experiment):
    ...
    if experiment == "training":
        ...
        for trial_no in range(len(allstimlist)):
            ...
            RESULTS.append([PART_ID, trial_no, reaction_time, correctness, experiment, sex, age, go_no_go])
